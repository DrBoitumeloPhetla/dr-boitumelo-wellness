-- Migration Script: Add Existing Products to Database (FIXED)
...
BEGIN
  IF EXISTS (SELECT 1 FROM products LIMIT 1) THEN
    RAISE NOTICE 'Products table already has data. Skipping insert.';
    RAISE NOTICE 'If you want to re-run this, delete existing products first.';
  ELSE
