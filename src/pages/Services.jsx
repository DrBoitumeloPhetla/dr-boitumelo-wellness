    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-br from-primary-green to-green-dark text-white pt-32 pb-20 px-6 mt-20">
        <div className="container-custom">
          ...
          >
            <h1 className="heading-primary text-white mb-4">Wellness Services</h1>
            <div className="w-20 h-1 bg-gold mx-auto mb-6" />
            <p className="text-lg md:text-xl text-white/90">
              Comprehensive holistic health services designed to support your wellness journey from consultation to ongoing care
            </p>
          </motion.div>
        </div>
      </section>
