                ...
                >
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-600 text-sm mt-1">In-person consultation with Dr. Boitumelo. Includes a 30 minute complimentary telephone feedback session for results and way forward.</p>
